...
(function () {
    var Slide = function (customConfig) {
        ...
        this.effect = params.effect || 'fade';//black  d3dV flip fade 动画效果
    ...
    Slide.prototype.moveNext = function (curPage, prePage) {
        ...
        if (this.effect == 'black') {
            curPage.style.animation = '' + this.effect + '1 ' + this.speed + 's ease 0s  1 both';
    ...
    Slide.prototype.movePre = function (curPage, prePage) {
        ...
        prePage.style.display = 'block';
        if (this.effect == 'black') {
            curPage.style.animation = '' + this.effect + '3 ' + this.speed + 's ease 0s  1 both';
    ...
    Slide.prototype.initMusic = function () {
        ...
        this.musicPic&&this.musicPic.addEventListener('touchend', function (event) {
