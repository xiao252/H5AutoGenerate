...
function run(){
    ...
    var templatePath =new File($.fileName).parent+"/TemplateIMG/";
    try{
...
function replaceSymbol(set,path,startMark,adoc,resources){
    ...
    var html_bg='\n\t\t<img src="{{BgImgSrc}}" class="full" style="-webkit-animation: scaletest 1s ease-out {{modeTIme}}s 1 both">';
    var html_img_t = '\n\t\t<img src="{{imgSrc}}?v=1" style="position:absolute;{{imgCss}}-webkit-animation: {{aniName}} {{aniTime}}s ease {{modeTIme}}s 1 both;">';
    var html_img = "";
